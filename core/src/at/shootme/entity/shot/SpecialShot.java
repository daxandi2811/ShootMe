 ...
 */
public class SpecialShot extends SimpleDrawableEntity implements Shot {

    private static final String TEXTUREPATH = "assets/SpecialShot.png";
    private static final int SCORE_FOR_KILLING_HIT = 1000;
    public static final Vector2 SIZE = new Vector2(150, 150).scl(PIXELS_TO_METERS);
    private Entity originator;
    private Sound shotSound = Gdx.audio.newSound(Gdx.files.internal("assets/shot.wav"));

    public SpecialShot(Vector2 position, Vector2 initialVelocity, Entity originator, World world) {
...
//            }
    ...
    public static class SpecialShotCreationMessage extends EntityCreationMessage {
