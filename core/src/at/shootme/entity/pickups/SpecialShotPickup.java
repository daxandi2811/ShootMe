 ...
 */
public class SpecialShotPickup extends SimpleDrawableEntity implements Pickup {

    public static final Vector2 SIZE = new Vector2(100, 100).scl(PIXELS_TO_METERS);
    public final PickupType type = PickupType.SPECIAL_SHOT;
    private Sound pickupSound = Gdx.audio.newSound(Gdx.files.internal("assets/speedUpPickup.wav"));

    public SpecialShotPickup(Vector2 position) {
        sprite = new Sprite(SM.textureStore.getOrLoadTexture("assets/SpecialShot.png"));
